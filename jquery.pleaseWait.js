	...
	var methods = {
		init: function(settings) {
			...
			return this.each(function() {
				...
				if (self.pleaseWait.opt.image_type != 'encoded' && image.length > 0) {
